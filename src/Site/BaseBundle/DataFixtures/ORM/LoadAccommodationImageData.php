...
class LoadAccommodationImageData extends AbstractFixture implements OrderedFixtureInterface
{
  public function load(ObjectManager $manager)
  {
    for ($i = 2; $i <= 5; $i++)
    {
      ...
      $o->setFilename('estancia_perales' . $i)->setAccommodation($this->getReference('a-estancia-perales'));
      $manager->persist($o);
    }
    ...
    {
      $o = new AccommodationImage();
      $o->setFilename('monte_balmaceda' . $i)->setAccommodation($this->getReference('a-monte-balmaceda'));
      $manager->persist($o);
    }
