...
/**
 * @ORM\Table(name="routes__translations", indexes={
 *      @ORM\Index(name="translations_idx", columns={"locale", "object_id", "field"})
 * })
 * @ORM\Entity()
 * @ORM\HasLifecycleCallbacks
 */
class RouteTranslation extends AbstractPersonalTranslation
{
  /**
  ...
  /**
   * @var \Site\BaseBundle\Entity\Route $object
   * @ORM\ManyToOne(targetEntity="Site\BaseBundle\Entity\Route", inversedBy="translations")
